...
public class Nwc2MusicXMLTest_DCalCoda {

	@Test
	public void testMain() {
		String[] args = new String[2];
		args[0] = "TestFiles/Test DCalCoda.nwctxt";
		args[1] = "bin/TestDCalCoda.xml";
		Nwc2MusicXML.main(args);
		
		String refFile = "TestFiles/TestDCalCoda.xml";
		...
		try {
			...
			if (!IOUtils.contentExceptEncodingDateEquals(in1, in2))
				fail("Files Different: DC al Coda");
		} catch (IOException ioe) {
			fail("IOException " + ioe.getMessage());
		}
		System.out.println("Test Success: DC al Coda");
	}
}
